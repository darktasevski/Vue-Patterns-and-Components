...
export default {
	...
	created() {
		...
		// Instead of declaring destroyed hood we can access it here like this
		// Pros of this approach is that it's less code and we don't have to add escapeHandler to this instance so that
		// we can access it in another lifecycle hook. $once means that this will be called only once, duh
