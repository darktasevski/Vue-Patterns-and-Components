<template>
	<div class="container mx-auto font-sans antialiased my-16 text-black">
		...
		<get-json
			endpoint="https://cors-anywhere.herokuapp.com/https://api-endpoint.igdb.com/games/?fields=name,genres.name,cover,popularity&order=popularity:desc&expand=genres"
		>
		...
		<get-json
			endpoint="https://cors-anywhere.herokuapp.com/https://api-endpoint.igdb.com/games/?search=Super Mario&fields=name,cover,genres.name&expand=genres"
		>
			<grid-layout slot-scope="{ response: games }" :games="games"></grid-layout>
		</get-json>
	</div>
